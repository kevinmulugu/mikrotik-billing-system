...
export const metadata: Metadata = {
  title: 'All Users - MikroTik Billing',
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Hotspot Users</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">PPPoE Users</p>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Global user management interface will be loaded here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Global hotspot user interface will be loaded here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Global PPPoE user interface will be loaded here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
